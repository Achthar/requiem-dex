...
interface Requiem2PoolTokensInterface extends ethers.utils.Interface {
  functions: {
...
export class Requiem2PoolTokens extends BaseContract {
  ...
  interface: Requiem2PoolTokensInterface;
