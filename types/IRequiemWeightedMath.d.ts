...
interface IRequiemWeightedMathInterface extends ethers.utils.Interface {
  functions: {
    ...
    "_computeExitExactTokensOutInvariantRatio(uint256[],uint256[],uint256[],uint256[],uint256,uint256)": FunctionFragment;
    "_computeJoinExactTokensInInvariantRatio(uint256[],uint256[],uint256[],uint256[],uint256,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "_computeExitExactTokensOutInvariantRatio",
    values: [
      BigNumberish[],
      BigNumberish[],
      BigNumberish[],
  ...
  encodeFunctionData(
    functionFragment: "_computeJoinExactTokensInInvariantRatio",
    values: [
      BigNumberish[],
      BigNumberish[],
      BigNumberish[],
...
export class IRequiemWeightedMath extends BaseContract {
  ...
  functions: {
    ...
    _computeExitExactTokensOutInvariantRatio(
      ...
      normalizedWeights: BigNumberish[],
      amountsOut: BigNumberish[],
      balanceRatiosWithoutFee: BigNumberish[],
      invariantRatioWithoutFees: BigNumberish,
      swapFeePercentage: BigNumberish,
      overrides?: CallOverrides
    ): Promise<
      [BigNumber, BigNumber[]] & {
    ...
    _computeJoinExactTokensInInvariantRatio(
      ...
      normalizedWeights: BigNumberish[],
      amountsIn: BigNumberish[],
      balanceRatiosWithFee: BigNumberish[],
      invariantRatioWithFees: BigNumberish,
      swapFeePercentage: BigNumberish,
      overrides?: CallOverrides
    ): Promise<
      [BigNumber, BigNumber[]] & {
