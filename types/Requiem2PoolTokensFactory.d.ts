...
interface Requiem2PoolTokensFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class Requiem2PoolTokensFactory extends BaseContract {
  ...
  interface: Requiem2PoolTokensFactoryInterface;
