 ...
 */
contract VaultAuthorizer is IVaultAuthorizer, ReentrancyGuard, Authentication, SignaturesValidatorVault, TemporarilyPausableVault {
    ...
    constructor(
        ...
        TemporarilyPausableVault(pauseWindowDuration, bufferPeriodDuration)
    {
    ...
    function setRelayerApproval(
        ...
        address relayer,
        bool approved
    ) external nonReentrant whenNotPausedVault {
